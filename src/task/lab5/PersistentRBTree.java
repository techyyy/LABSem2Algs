...
public class PersistentRBTree<T extends Comparable<? super T>> {
    private Node root;
    private Node tnull;
    ...
    private class Node {
        ...
        public Node(T data, Node parent, Node left, Node right, int color) {
            this.data = data;
            this.parent = parent;
            this.left = left;
            this.right = right;
        ...
        private Node copy() {
            ...
            Node tempRight = null;
            if (this.left != null) {
                tempLeft = this.left.copy();
            }
            if (this.right != null) {
                tempRight = this.right.copy();
            }
            return new Node(data,parent, tempLeft, tempRight, color);
        }
    }

    public Node getVersion(int k) {
    ...
    public static void main(String [] args){
        PersistentRBTree<Integer> tree = new PersistentRBTree<>();
        tree.add(5);
        tree.add(4);
        tree.add(3);
        tree.add(2);
//        System.out.println(tree.inOrderTraversal(tree.getVersion(), new ArrayList<>()));
        System.out.println(tree.inOrderTraversal(tree.getRoot().copy(), new ArrayList<>()));
